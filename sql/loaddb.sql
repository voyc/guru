...
insert into guru.quote (workid,content) values (1,'All you need is already within you, only you must approach your self with reverence and love.  Self-condemnation and self-distrust are grievous errors.  Your constant flight from pain and search for pleasure is a sign of love you bear for your self, all I plead with you is this: make love of your self perfect.  Deny yourself nothing -- glue your self infinity and eternity and discover that you do not need them; you are beyond.');
...
insert into guru.quote (workid,content) values (1,'Q: But, is it true that all existence is painful? M: What else can be the c byause of this universal search for pleasure? Does a happy man seek happiness?');
...
insert into guru.work (id, name, author) values (2, 'The Cosmic Law (youtube)','Ramesh Balsekar');

insert into guru.quote (workid,content) values (2,'Don''t blame yourself.  Don''t blame anyone else.  No guilt, shame, hatred, anger.');
insert into guru.quote (workid,content) values (2,'Nothing can happen that is not God''s will.');
insert into guru.quote (workid,content) values (2,'You cannot make a mistake.  You cannot commit a sin.');
...
insert into guru.work (id, name, author) values (13, 'Unknown', 'Unknown');
